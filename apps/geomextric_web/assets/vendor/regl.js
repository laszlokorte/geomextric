(function (Z, ja) {
  ...
  function ja(a) {
    ...
    if ((b = /\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(a)))
      return ja(a.substr(0, b.index))
        .concat(ja(b[1]))
        .concat(ja(a.substr(b.index + b[0].length)));
    b = a.split(".");
    if (1 === b.length)
      return ['"' + a.replace(/\\/g, "\\\\").replace(/"/g, '\\"') + '"'];
    a = [];
    for (c = 0; c < b.length; ++c) a = a.concat(ja(b[c]));
    return a;
  }
  function cb(a) {
    return "[" + ja(a).join("][") + "]";
  ...
  function db(a, b) {
    if ("function" === typeof a) return new Z(0, a);
    if ("number" === typeof a || "boolean" === typeof a) return new Z(5, a);
    if (Array.isArray(a))
      return new Z(
        6,
        a.map(function (a, e) {
  ...
  function Fb(a, b, c) {
    ...
    a.appendChild(f);
    a === document.body &&
      ((f.style.position = "absolute"), N(a.style, { margin: 0, padding: 0 }));
    var d;
        ...
        "function" === typeof b.getBoundingClientRect
          ...
          : "function" === typeof b.drawArrays ||
            ...
            : ("gl" in b
                ...
                : "canvas" in b
                  ? (f = fb(b.canvas))
                  : "container" in b && (e = fb(b.container)),
              "attributes" in b && (a = b.attributes),
              "extensions" in b && (q = eb(b.extensions)),
              "optionalExtensions" in b && (n = eb(b.optionalExtensions)),
              "onDone" in b && (v = b.onDone),
              "profile" in b && (h = !!b.profile),
              "pixelRatio" in b && (u = +b.pixelRatio)));
    c && ("canvas" === c.nodeName.toLowerCase() ? (f = c) : (e = c));
    if (!d) {
      if (!f) {
        c = Fb(e || document.body, v, u);
        if (!c) return null;
        f = c.canvas;
        m = c.onDestroy;
      }
  ...
  function ka(a) {
    return (
      ...
      (Array.isArray(a.data) || Q(a.data))
    );
  }
  function ib(a, b, c, e, f, d) {
    for (var q = 0; q < b; ++q)
      for (var n = a[q], u = 0; u < c; ++u)
        for (var h = n[u], v = 0; v < e; ++v) f[d++] = h[v];
  }
  function jb(a, b, c, e, f) {
    for (var d = 1, q = c + 1; q < b.length; ++q) d *= b[q];
    var n = b[c];
    if (4 === b.length - c) {
      var u = b[c + 1],
        h = b[c + 2];
      b = b[c + 3];
      for (q = 0; q < n; ++q) (ib(a[q], u, h, b, e, f), (f += d));
  ...
  function lb(a, b, c, e, f, d, q) {
    for (var n = 0, u = 0; u < c; ++u)
      for (var h = 0; h < e; ++h) a[n++] = b[f * u + d * h + q];
  }
  function Jb(a, b, c, e) {
    function f(b) {
      this.id = u++;
    ...
    function d(b, c, p) {
      ...
      a.bufferData(b.type, c, p);
    }
    function q(a, b, c, k, g, r) {
      a.usage = c;
      if (Array.isArray(b)) {
        if (((a.dtype = k || 5126), 0 < b.length))
          if (Array.isArray(b[0])) {
            g = mb(b);
            for (var l = (k = 1); l < g.length; ++l) k *= g[l];
            a.dimension = k;
            b = Ua(b, g, a.dtype);
            d(a, b, c);
            r ? (a.persistentData = b) : I.freeType(b);
          } else
            "number" === typeof b[0]
              ? ((a.dimension = g),
                (g = I.allocType(a.dtype, b.length)),
                kb(g, b),
                d(a, g, c),
                r ? (a.persistentData = g) : I.freeType(g))
              : Q(b[0]) &&
                ((a.dimension = b[0].length),
                (a.dtype = k || Ga(b[0]) || 5126),
                (b = Ua(b, [b.length, b[0].length], a.dtype)),
                d(a, b, c),
                r ? (a.persistentData = b) : I.freeType(b));
      } else if (Q(b))
        ((a.dtype = k || Ga(b)),
          (a.dimension = g),
          d(a, b, c),
          r && (a.persistentData = new Uint8Array(new Uint8Array(b.buffer))));
      else if (ka(b)) {
        g = b.shape;
        var e = b.stride,
          l = b.offset,
        ...
        1 === g.length
          ? ((t = g[0]), (f = 1), (h = e[0]), (n = 0))
          : 2 === g.length && ((t = g[0]), (f = g[1]), (h = e[0]), (n = e[1]));
        a.dtype = k || Ga(b.data) || 5126;
        a.dimension = f;
        g = I.allocType(a.dtype, t * f);
        lb(g, b.data, t, f, h, n, l);
        d(a, g, c);
        r ? (a.persistentData = g) : I.freeType(g);
      } else
        b instanceof ArrayBuffer &&
          ...
          (a.dimension = g),
          d(a, b, c),
          r && (a.persistentData = new Uint8Array(new Uint8Array(b))));
    }
    function n(c) {
      b.bufferCount--;
      e(c);
      ...
      create: function (m, e, d, k) {
        function g(b) {
          var e = 35044,
            ...
            m = 0,
            f = 1;
          Array.isArray(b) || Q(b) || ka(b) || b instanceof ArrayBuffer
            ? (t = b)
            : "number" === typeof b
              ? (d = b | 0)
              : b &&
                ("data" in b && (t = b.data),
                "usage" in b && (e = nb[b.usage]),
                "type" in b && (m = Ja[b.type]),
                "dimension" in b && (f = b.dimension | 0),
                "length" in b && (d = b.length | 0));
          r.bind();
          t
            ? q(r, t, e, m, f, k)
            : (d && a.bufferData(r.type, d, e),
              (r.dtype = m || 5121),
              (r.usage = e),
              (r.dimension = f),
              (r.byteLength = d));
          c.profile && (r.stats.size = r.byteLength * ma[r.dtype]);
          return g;
        }
        b.bufferCount++;
        var r = new f(e);
        ...
        g.subdata = function (b, c) {
          var t = (c || 0) | 0,
            d;
          r.bind();
          if (Q(b) || b instanceof ArrayBuffer) a.bufferSubData(r.type, t, b);
          else if (Array.isArray(b)) {
            if (0 < b.length)
              if ("number" === typeof b[0]) {
                var e = I.allocType(r.dtype, b.length);
                kb(e, b);
                a.bufferSubData(r.type, t, e);
                I.freeType(e);
              } else if (Array.isArray(b[0]) || Q(b[0]))
                ((d = mb(b)),
                  (e = Ua(b, d, r.dtype)),
                  a.bufferSubData(r.type, t, e),
                  I.freeType(e));
            ...
            1 === d.length
              ? ((e = d[0]), (f = 1), (k = m[0]), (y = 0))
              : 2 === d.length &&
                ((e = d[0]), (f = d[1]), (k = m[0]), (y = m[1]));
            d = Array.isArray(b.data) ? r.dtype : Ga(b.data);
            d = I.allocType(d, e * f);
            lb(d, b.data, e, f, k, y, b.offset);
            a.bufferSubData(r.type, t, d);
            I.freeType(d);
          }
          return g;
        };
        c.profile && (g.stats = r.stats);
        g.destroy = function () {
          n(r);
        };
        return g;
  ...
  function Kb(a, b, c, e) {
    ...
    function d(d, e, f, k, g, r, l) {
      d.buffer.bind();
      var h;
      e
        ? ((h = l) ||
            (Q(e) && (!ka(e) || Q(e.data))) ||
            (h = b.oes_element_index_uint ? 5125 : 5123),
          c._initBuffer(d.buffer, e, f, h, 3))
        : (a.bufferData(34963, r, f),
          (d.buffer.dtype = h || 5121),
          (d.buffer.usage = f),
          (d.buffer.dimension = 3),
          (d.buffer.byteLength = r));
      h = l;
      if (!l) {
      ...
      0 > e &&
        ...
        5123 === h ? (e >>= 1) : 5125 === h && (e >>= 2));
      d.vertCount = e;
      e = k;
      0 > k &&
        ((e = 4),
        (k = d.buffer.dimension),
        1 === k && (e = 0),
        2 === k && (e = 1),
        3 === k && (e = 4));
      d.primType = e;
    ...
    var n = {},
      u = 0,
      h = { uint8: 5121, uint16: 5123 };
    b.oes_element_index_uint && (h.uint32 = 5125);
    f.prototype.bind = function () {
      this.buffer.bind();
    };
    var v = [];
    return {
      create: function (a, b) {
        function p(a) {
          if (a)
            if ("number" === typeof a)
              (k(a), (g.primType = 4), (g.vertCount = a | 0), (g.type = 5121));
            else {
              var b = null,
                c = 35044,
                e = -1,
                ...
                n = 0,
                m = 0;
              if (Array.isArray(a) || Q(a) || ka(a)) b = a;
              else if (
                ("data" in a && (b = a.data),
                "usage" in a && (c = nb[a.usage]),
                "primitive" in a && (e = Ka[a.primitive]),
                "count" in a && (f = a.count | 0),
                "type" in a && (m = h[a.type]),
                "length" in a)
              )
                n = a.length | 0;
              else if (((n = f), 5123 === m || 5122 === m)) n *= 2;
              else if (5125 === m || 5124 === m) n *= 4;
              d(g, b, c, e, f, n, m);
            }
          else (k(), (g.primType = 4), (g.vertCount = 0), (g.type = 5121));
          return p;
        }
        var k = c.create(null, 34963, !0),
          g = new f(k._buffer);
        e.elementsCount++;
        p(a);
        p._reglType = "elements";
        p._elements = g;
        p.subdata = function (a, b) {
          k.subdata(a, b);
          return p;
        };
        p.destroy = function () {
  ...
  function ob(a) {
    for (var b = I.allocType(5123, a.length), c = 0; c < a.length; ++c)
  ...
  function Va(a) {
    if (!a) return !1;
    var b = aa(a);
    return 0 <= Mb.indexOf(b) ? !0 : qb(a) || rb(a) || ka(a);
  }
  function sb(a, b) {
    36193 === a.type ? ((a.data = ob(b)), I.freeType(b)) : (a.data = b);
  }
  function La(a, b, c, e, f, d) {
    a = "undefined" !== typeof E[a] ? E[a] : V[a] * ya[b];
    d && (a *= 6);
    if (f) {
  ...
  function Nb(a, b, c, e, f, d, q) {
    ...
    function h(a, b) {
      if ("object" === typeof b && b) {
        ...
        "colorSpace" in b && (a.colorSpace = Ob[b.colorSpace]);
        "type" in b && (a.type = P[b.type]);
        var c = a.width,
          e = a.height,
          d = a.channels,
          f = !1;
        ...
        "format" in b &&
          ((c = b.format),
          (e = a.internalformat = G[c]),
          (a.format = W[e]),
          c in P && !("type" in b) && (a.type = P[c]),
          c in ha && (a.compressed = !0),
          (c = !0));
        !f && c
          ? (a.channels = V[a.format])
          : f &&
            !c &&
            a.channels !== Oa[a.format] &&
            (a.format = a.internalformat = Oa[a.channels]);
      }
    }
    function v(b) {
    ...
    function C(a, b) {
      ...
      if (b.copy) {
        ...
        Array.isArray(e) ||
          5121 !== a.type ||
          (a.type = Ha[Object.prototype.toString.call(e)] | 0);
        var d = c.shape,
          g = c.stride,
          y,
          t,
        ...
        a.height = t;
        a.channels = l;
        a.format = a.internalformat = Oa[l];
        a.needsFree = !0;
        y = k;
        c = c.offset;
        l = a.width;
        ...
        t = a.channels;
        for (
          var w = I.allocType(36193 === a.type ? 5126 : a.type, l * k * t),
            B = 0,
            da = 0;
          da < k;
          ++da
          ...
          for (var xa = 0; xa < l; ++xa)
            for (var Wa = 0; Wa < t; ++Wa)
              w[B++] = e[d * xa + g * da + y * Wa + c];
        sb(a, w);
      } else if (aa(c) === Xa || aa(c) === Ya || aa(c) === ub)
        (aa(c) === Xa || aa(c) === Ya
          ? (a.element = c)
          : (a.element = c.canvas),
        ...
        d = a.height || c.length;
        g = a.channels;
        g = pa(c[0][0]) ? g || c[0][0].length : g || 1;
        y = Qa.shape(c);
        l = 1;
        for (k = 0; k < y.length; ++k) l *= y[k];
        l = I.allocType(36193 === a.type ? 5126 : a.type, l);
        Qa.flatten(c, y, "", l);
        sb(a, l);
        a.alignment = 1;
        a.width = e;
        a.height = d;
        a.channels = g;
        a.format = a.internalformat = Oa[g];
        a.needsFree = !0;
      }
    }
    function p(b, c, d, g, l) {
      var f = b.element,
        y = b.data,
        k = b.internalformat,
        t = b.format,
      ...
      v(b);
      f
        ? a.texSubImage2D(c, l, d, g, t, h, f)
        : b.compressed
          ? a.compressedTexSubImage2D(c, l, d, g, k, w, B, y)
          : b.needsCopy
            ? (e(), a.copyTexSubImage2D(c, l, d, g, b.xOffset, b.yOffset, w, B))
            : a.texSubImage2D(c, l, d, g, w, B, t, h, y);
    }
    function k() {
      return S.pop() || new m();
    }
    function g(a) {
      a.needsFree && I.freeType(a.data);
      m.call(a);
      S.push(a);
    }
    function r() {
    ...
    function D(a, b) {
      var c = null;
      if (Va(b)) ((c = a.images[0] = k()), u(c, a), C(c, b), (a.mipmask = 1));
      else if ((h(a, b), Array.isArray(b.mipmap)))
        for (var d = b.mipmap, e = 0; e < d.length; ++e)
          ((c = a.images[e] = k()),
            ...
            C(c, d[e]),
            (a.mipmask |= 1 << e));
      else ((c = a.images[0] = k()), u(c, a), C(c, b), (a.mipmask = 1));
      u(a, a.images[0]);
    }
    function t(b, c) {
      for (var d = b.images, g = 0; g < d.length && d[g]; ++g) {
        var l = d[g],
          f = c,
          y = g,
          k = l.element,
        ...
        v(l);
        k
          ? a.texImage2D(f, y, w, w, B, k)
          : l.compressed
            ? a.compressedTexImage2D(f, y, h, da, xa, 0, t)
            : l.needsCopy
              ? (e(),
                a.copyTexImage2D(f, y, w, l.xOffset, l.yOffset, da, xa, 0))
              : a.texImage2D(f, y, w, da, xa, 0, w, B, t || null);
      }
    }
    function Ia() {
      var a = Y.pop() || new r();
    ...
    function J(a, b) {
      "min" in b &&
        ((a.minFilter = za[b.min]),
        0 <= Pb.indexOf(a.minFilter) && !("faces" in b) && (a.genMipmaps = !0));
      ...
      if ("wrap" in b) {
        ...
        "string" === typeof e
          ? (c = d = ia[e])
          : Array.isArray(e) && ((c = ia[e[0]]), (d = ia[e[1]]));
      } else
        ("wrapS" in b && (c = ia[b.wrapS]), "wrapT" in b && (d = ia[b.wrapT]));
      a.wrapS = c;
      a.wrapT = d;
    ...
    function H(b) {
      var c = b.texture,
        ...
        l = b.target;
      0 <= e &&
        (a.activeTexture(33984 + e), a.bindTexture(l, null), (X[e] = null));
      a.deleteTexture(c);
      b.texture = null;
      b.params = null;
      b.pixels = null;
    ...
    var z = { "don't care": 4352, "dont care": 4352, nice: 4354, fast: 4353 },
      ia = { repeat: 10497, clamp: 33071, mirror: 33648 },
      ...
      Ob = { none: 0, browser: 37444 },
      P = { uint8: 5121, rgba4: 32819, rgb565: 33635, "rgb5 a1": 32820 },
      G = {
        alpha: 6406,
        luminance: 6409,
    ...
    b.oes_texture_float && (P.float32 = P["float"] = 5126);
    b.oes_texture_half_float && (P.float16 = P["half float"] = 36193);
    b.webgl_depth_texture &&
      (N(G, { depth: 6402, "depth stencil": 34041 }),
      N(P, { uint16: 5123, uint32: 5125, "depth stencil": 34042 }));
    ...
    b.webgl_compressed_texture_etc1 && (ha["rgb etc1"] = 36196);
    var L = Array.prototype.slice.call(a.getParameter(34467));
    ...
    var W = E.reduce(function (a, c) {
        ...
        6402 === d ||
        34041 === d ||
        (b.ext_srgb && (35904 === d || 35906 === d))
          ? (a[d] = d)
          : 32855 === d || 0 <= c.indexOf("rgba")
            ? (a[d] = 6408)
            : (a[d] = 6407);
        return a;
      }, {}),
    ...
    N(y.prototype, {
      bind: function () {
        ...
        if (0 > b) {
          ...
          q.profile && d.maxTextureUnits < b + 1 && (d.maxTextureUnits = b + 1);
          this.unit = b;
      ...
      decRef: function () {
        0 >= --this.refCount && H(this);
      },
    });
    q.profile &&
      (d.getTotalTextureSize = function () {
        var a = 0;
        Object.keys(fa).forEach(function (b) {
          a += fa[b].stats.size;
        });
        return a;
      });
    return {
      create2D: function (b, c) {
        function e(a, b) {
          ...
          e.format = ea[f.internalformat];
          e.type = M[f.type];
          e.mag = Ea[c.magFilter];
          e.min = na[c.minFilter];
          e.wrapS = oa[c.wrapS];
          e.wrapT = oa[c.wrapT];
          return e;
        }
        ...
        e.subimage = function (a, b, c, d) {
          ...
          l.height = 0;
          C(l, a);
          l.width = l.width || (f.width >> d) - b;
          l.height = l.height || (f.height >> d) - c;
          U(f);
          p(l, 3553, b, c, d);
          ua();
          g(l);
        ...
        e.resize = function (b, c) {
          var d = b | 0,
            l = c | 0 || d;
          if (d === f.width && l === f.height) return e;
          e.width = f.width = d;
          e.height = f.height = l;
          U(f);
          for (var g = 0; f.mipmask >> g; ++g) {
            var y = d >> g,
              w = l >> g;
            if (!y || !w) break;
            a.texImage2D(3553, g, f.format, y, w, 0, f.format, f.type, null);
          }
          ua();
          q.profile &&
            (f.stats.size = La(f.internalformat, f.type, d, l, !1, !1));
          return e;
        };
        e._reglType = "texture2d";
        e._texture = f;
        q.profile && (e.stats = f.stats);
        e.destroy = function () {
          f.decRef();
        };
        return e;
      ...
      createCube: function (b, c, e, f, n, r) {
        function z(a, b, c, d, e, f) {
          var g,
            A = m.texInfo;
          x.call(A);
          for (g = 0; 6 > g; ++g) H[g] = Ia();
          if ("number" === typeof a || !a)
            for (a = a | 0 || 1, g = 0; 6 > g; ++g) l(H[g], a, a);
            ...
            if (b)
              (D(H[0], a),
                ...
                D(H[4], e),
                D(H[5], f));
            else if ((J(A, a), h(m, a), "faces" in a))
              for (a = a.faces, g = 0; 6 > g; ++g) (u(H[g], m), D(H[g], a[g]));
            else for (g = 0; 6 > g; ++g) D(H[g], a);
          u(m, H[0]);
          m.mipmask = A.genMipmaps ? (H[0].width << 1) - 1 : H[0].mipmask;
          m.internalformat = H[0].internalformat;
          z.width = H[0].width;
          z.height = H[0].height;
          U(m);
          for (g = 0; 6 > g; ++g) t(H[g], 34069 + g);
          O(A, 34067);
          ua();
          q.profile &&
            (m.stats.size = La(
          ...
          z.format = ea[m.internalformat];
          z.type = M[m.type];
          z.mag = Ea[A.magFilter];
          z.min = na[A.minFilter];
          z.wrapS = oa[A.wrapS];
          z.wrapT = oa[A.wrapT];
          for (g = 0; 6 > g; ++g) wa(H[g]);
          return z;
        }
        var m = new y(34067);
        fa[m.id] = m;
        ...
        z.subimage = function (a, b, c, d, e) {
          ...
          f.height = 0;
          C(f, b);
          f.width = f.width || (m.width >> e) - c;
          f.height = f.height || (m.height >> e) - d;
          U(m);
          p(f, 34069 + a, c, d, e);
          ua();
          g(f);
      ...
      restore: function () {
        for (var b = 0; b < ga; ++b) {
          var c = X[b];
          c && ((c.bindCount = 0), (c.unit = -1), (X[b] = null));
        }
        K(fa).forEach(function (b) {
  ...
  function Rb(a, b, c, e, f, d) {
    ...
    function m(a, b, c, d, g) {
      if (c)
        return (
          (a = e.create2D({ width: a, height: b, format: d, type: g })),
          (a._texture.refCount = 0),
          new q(3553, a, null)
        );
      a = f.create({ width: a, height: b, format: d });
      a._renderbuffer.refCount = 0;
      return new q(36161, null, a);
    }
    function C(a) {
    ...
    function l(b) {
      ...
      for (d = 0; d < e.length; ++d) h(36064 + d, e[d]);
      ...
      h(36096, b.depthAttachment);
      h(36128, b.stencilAttachment);
      h(33306, b.depthStencilAttachment);
    ...
    function D(a, b) {
      function c(a, b) {
        ...
        var n = !0,
          ...
          na = null,
          O = !1;
        if ("number" === typeof a) ((f = a | 0), (k = b | 0 || f));
        else if (a) {
          "shape" in a
            ? ((k = a.shape), (f = k[0]), (k = k[1]))
            : ("radius" in a && (f = k = a.radius),
              "width" in a && (f = a.width),
              "height" in a && (k = a.height));
          if ("color" in a || "colors" in a)
            ((d = a.color || a.colors), Array.isArray(d));
          if (!d) {
            "colorCount" in a && (q = a.colorCount | 0);
            "colorTexture" in a && ((n = !!a.colorTexture), (p = "rgba4"));
            if ("colorType" in a && ((r = a.colorType), !n))
              if ("half float" === r || "float16" === r) p = "rgba16f";
              else if ("float" === r || "float32" === r) p = "rgba32f";
            "colorFormat" in a &&
              ((p = a.colorFormat),
              0 <= Ia.indexOf(p) ? (n = !0) : 0 <= wa.indexOf(p) && (n = !1));
          }
          if ("depthTexture" in a || "depthStencilTexture" in a)
            O = !(!a.depthTexture && !a.depthStencilTexture);
          "depth" in a &&
          ...
          "depthStencil" in a &&
            ("boolean" === typeof a.depthStencil
              ? (t = h = a.depthStencil)
              : ((na = a.depthStencil), (h = t = !1)));
        } else f = k = 1;
        var W = null,
          J = null,
          U = null,
          x = null;
        if (Array.isArray(d)) W = d.map(v);
        else if (d) W = [v(d)];
        else for (W = Array(q), d = 0; d < q; ++d) W[d] = m(f, k, n, p, r);
        f = f || W[0].width;
        k = k || W[0].height;
        y ? (J = v(y)) : t && !h && (J = m(f, k, O, "depth", "uint32"));
        D ? (U = v(D)) : h && !t && (U = m(f, k, !1, "stencil", "uint8"));
        na
          ? (x = v(na))
          : !y &&
            !D &&
            h &&
            t &&
            (x = m(f, k, O, "depth stencil", "depth stencil"));
        t = null;
        for (d = 0; d < W.length; ++d)
          (u(W[d], f, k),
            W[d] &&
              W[d].texture &&
              ((h =
                Za[W[d].texture._texture.format] *
                Ra[W[d].texture._texture.type]),
              null === t && (t = h)));
        u(J, f, k);
        u(U, f, k);
        u(x, f, k);
        ...
        e.width = f;
        e.height = k;
        e.colorAttachments = W;
        e.depthAttachment = J;
        e.stencilAttachment = U;
        e.depthStencilAttachment = x;
        c.color = W.map(C);
        c.depth = C(J);
        c.stencil = C(U);
        c.depthStencil = C(x);
      ...
      return N(c, {
        resize: function (a, b) {
          ...
          for (var g = e.colorAttachments, k = 0; k < g.length; ++k)
            p(g[k], d, f);
          p(e.depthAttachment, d, f);
          p(e.stencilAttachment, d, f);
          p(e.depthStencilAttachment, d, f);
          e.width = c.width = d;
          e.height = c.height = f;
          l(e);
          return c;
        ...
        use: function (a) {
          t.setFBO({ framebuffer: c }, a);
        },
      });
    }
    var t = { cur: null, next: null, dirty: !1, setFBO: null },
      Ia = ["rgba"],
    ...
    return N(t, {
      getFramebuffer: function (a) {
        return "function" === typeof a &&
          ...
          ((a = a._framebuffer), a instanceof k)
          ? a
          : null;
      },
      create: D,
      createCube: function (a) {
        function b(a) {
          ...
          var k = "uint8",
            t = 1;
          if ("number" === typeof a) g = a | 0;
          else if (a) {
            "shape" in a
              ? (g = a.shape[0])
              : ("radius" in a && (g = a.radius | 0),
                "width" in a
                  ? (g = a.width | 0)
                  : "height" in a && (g = a.height | 0));
            if ("color" in a || "colors" in a)
              ((l = a.color || a.colors), Array.isArray(l));
            l ||
              ("colorCount" in a && (t = a.colorCount | 0),
          ...
          if (l)
            if (Array.isArray(l))
              for (a = [], d = 0; d < l.length; ++d) a[d] = l[d];
            else a = [l];
          else
            for (
              a = Array(t), l = { radius: g, format: d, type: k }, d = 0;
              d < t;
              ++d
            )
              a[d] = e.createCube(l);
          ...
          for (d = 0; 6 > d; ++d) {
            for (t = 0; t < a.length; ++t) f.color[t].target = 34069 + d;
            0 < d &&
              ((f.depth = c[0].depth),
          ...
          return N(b, { width: g, height: g, color: a });
        }
        var c = Array(6);
        b(a);
        return N(b, {
  ...
  function Sb(a, b, c, e, f, d, q) {
    ...
    function u(c) {
      if (c !== r.currentVAO) {
        if (c) c.bindAttrs();
          ...
          for (var d = b.angle_instanced_arrays, e = 0; e < p.length; ++e) {
            var f = p[e];
            f.buffer
              ? (a.enableVertexAttribArray(e),
                ...
                d && f.divisor && d.vertexAttribDivisorANGLE(e, f.divisor))
              : (a.disableVertexAttribArray(e),
                a.vertexAttrib4f(e, f.x, f.y, f.z, f.w));
          }
          q.elements
            ? a.bindBuffer(34963, q.elements.buffer.buffer)
    ...
    var C = c.maxAttributes,
      p = Array(C);
    for (c = 0; c < C; ++c) p[c] = new $a();
    var k = 0,
      g = {},
      r = {
        Record: $a,
        ...
        currentVAO: null,
        targetVAO: null,
        restore: b.oes_vertex_array_object ? m : function () {},
        createVAO: function (a) {
          function b(a) {
            var e;
            Array.isArray(a)
              ? ((e = a),
                c.elements && c.ownsElements && c.elements.destroy(),
                (c.elements = null),
                (c.ownsElements = !1),
                (c.offset = 0),
                (c.count = 0),
              ...
              : (a.elements
                  ? ((e = a.elements),
                    c.ownsElements
                      ? ("function" === typeof e && "elements" === e._reglType
                          ? c.elements.destroy()
                          : c.elements(e),
                        (c.ownsElements = !1))
                      : d.getElements(a.elements)
                        ? ((c.elements = a.elements), (c.ownsElements = !1))
                        : ((c.elements = d.create(a.elements)),
                          (c.ownsElements = !0)))
                  : ((c.elements = null), (c.ownsElements = !1)),
                (e = a.attributes),
                (c.offset = 0),
                (c.count = -1),
                (c.instances = -1),
                (c.primitive = 4),
                c.elements &&
                  ((c.count = c.elements._elements.vertCount),
                  (c.primitive = c.elements._elements.primType)),
                "offset" in a && (c.offset = a.offset | 0),
                "count" in a && (c.count = a.count | 0),
                "instances" in a && (c.instances = a.instances | 0),
                "primitive" in a && (c.primitive = Ka[a.primitive]));
            a = {};
            var g = c.attributes;
            g.length = e.length;
            for (var l = 0; l < e.length; ++l) {
              var k = e[l],
                h = (g[l] = new $a()),
                m = k.data || k;
              if (Array.isArray(m) || Q(m) || ka(m)) {
                var n;
                c.buffers[l] &&
                  ((n = c.buffers[l]),
                  Q(m) && n._buffer.byteLength >= m.byteLength
                    ? n.subdata(m)
                    : (n.destroy(), (c.buffers[l] = null)));
                c.buffers[l] || (n = c.buffers[l] = f.create(k, 34962, !1, !0));
                ...
                f.getBuffer(k)
                  ? ((h.buffer = f.getBuffer(k)),
                    ...
                    (h.divisor = 0),
                    (h.state = 1))
                  : f.getBuffer(k.buffer)
                    ? ((h.buffer = f.getBuffer(k.buffer)),
                      (h.size = (+k.size || h.buffer.dimension) | 0),
                      (h.normalized = !!k.normalized || !1),
                      (h.type = "type" in k ? Ja[k.type] : h.buffer.dtype),
                      (h.offset = (k.offset || 0) | 0),
                      (h.stride = (k.stride || 0) | 0),
                      (h.divisor = (k.divisor || 0) | 0),
                      (h.state = 1))
                    : "x" in k &&
                      ((h.x = +k.x || 0),
                      (h.y = +k.y || 0),
            ...
            for (n = 0; n < c.buffers.length; ++n)
              !a[n] &&
                c.buffers[n] &&
                (c.buffers[n].destroy(), (c.buffers[n] = null));
            c.refresh();
            return b;
          }
          var c = new v();
          e.vaoCount += 1;
          b.destroy = function () {
            for (var a = 0; a < c.buffers.length; ++a)
              c.buffers[a] && c.buffers[a].destroy();
            c.buffers.length = 0;
            c.ownsElements &&
              (c.elements.destroy(),
              (c.elements = null),
        ...
        setVAO: b.oes_vertex_array_object ? n : u,
        clear: b.oes_vertex_array_object ? h : function () {},
      };
    v.prototype.bindAttrs = function () {
      for (
        var c = b.angle_instanced_arrays, e = this.attributes, f = 0;
        f < e.length;
        ++f
      ) {
        var g = e[f];
        g.buffer
          ? (a.enableVertexAttribArray(f),
            a.bindBuffer(34962, g.buffer.buffer),
            a.vertexAttribPointer(
              f,
              g.size,
              g.type,
            ...
            c && g.divisor && c.vertexAttribDivisorANGLE(f, g.divisor))
          : (a.disableVertexAttribArray(f),
            a.vertexAttrib4f(f, g.x, g.y, g.z, g.w));
      }
      for (c = e.length; c < C; ++c) a.disableVertexAttribArray(c);
      (c = d.getElements(this.elements))
        ? a.bindBuffer(34963, c.buffer.buffer)
        : a.bindBuffer(34963, null);
    };
    ...
    v.prototype.destroy = function () {
      if (this.vao) {
        var a = b.oes_vertex_array_object;
        this === r.currentVAO &&
          ((r.currentVAO = null), a.bindVertexArrayOES(null));
      ...
      this.ownsElements &&
        ...
        (this.elements = null),
        (this.ownsElements = !1));
      g[this.id] && (delete g[this.id], --e.vaoCount);
    };
    return r;
  }
  function Tb(a, b, c, e) {
    ...
    function u(c, g, h) {
      var l;
      l = q(35632, c.fragId);
      var m = q(35633, c.vertId);
      g = c.program = a.createProgram();
      a.attachShader(g, l);
      a.attachShader(g, m);
      if (h)
        for (l = 0; l < h.length; ++l)
          ((m = h[l]), a.bindAttribLocation(g, m[0], m[1]));
      a.linkProgram(g);
      m = a.getProgramParameter(g, 35718);
      e.profile && (c.stats.uniformsCount = m);
      var n = c.uniforms;
      for (l = 0; l < m; ++l)
        if ((h = a.getActiveUniform(g, l)))
          if (1 < h.size)
            for (var p = 0; p < h.size; ++p) {
              var u = h.name.replace("[0]", "[" + p + "]");
              d(n, new f(u, b.id(u), a.getUniformLocation(g, u), h));
            }
          else
            d(
              n,
              new f(h.name, b.id(h.name), a.getUniformLocation(g, h.name), h),
            );
      m = a.getProgramParameter(g, 35721);
      e.profile && (c.stats.attributesCount = m);
      c = c.attributes;
      for (l = 0; l < m; ++l)
        (h = a.getActiveAttrib(g, l)) &&
          d(c, new f(h.name, b.id(h.name), a.getAttribLocation(g, h.name), h));
    }
    var h = {},
      v = {},
      m = {},
      ...
      program: function (b, d, e, f) {
        ...
        return N(x, {
          destroy: function () {
            x.refCount--;
            if (0 >= x.refCount) {
              a.deleteProgram(x.program);
              var b = C.indexOf(x);
              C.splice(b, 1);
              c.shaderCount--;
            }
            0 >= p[x.vertId].refCount &&
              (a.deleteShader(v[x.vertId]),
              delete v[x.vertId],
              delete m[x.fragId][x.vertId]);
            Object.keys(m[x.fragId]).length ||
              (a.deleteShader(h[x.fragId]),
              delete h[x.fragId],
              delete m[x.fragId]);
          },
        });
  ...
  function Ub(a, b, c, e, f, d, q) {
    function n(d) {
      ...
      var m = 0,
        n = 0,
        p = e.framebufferWidth,
        k = e.framebufferHeight,
        g = null;
      Q(d)
        ? (g = d)
        : d &&
          ((m = d.x | 0),
          (n = d.y | 0),
          (p = (d.width || e.framebufferWidth - m) | 0),
          (k = (d.height || e.framebufferHeight - n) | 0),
          (g = d.data || null));
      c();
      d = p * k * 4;
      g ||
        (5121 === f
          ? (g = new Uint8Array(d))
          : 5126 === f && (g = g || new Float32Array(d)));
      a.pixelStorei(3333, 4);
      a.readPixels(m, n, p, k, 6408, f, g);
      return g;
    }
    function u(a) {
      var c;
      ...
      return N(
        ...
        },
        {
          def: function () {
            ...
            b.push(d);
            0 < arguments.length &&
              (a.push(d, "="), a.push.apply(a, Aa(arguments)), a.push(";"));
            return d;
          },
          toString: function () {
            return Ba([0 < b.length ? "var " + b.join(",") + ";" : "", Ba(a)]);
          },
        },
      );
    }
  ...
  function Sa(a) {
    return Array.isArray(a) || Q(a) || ka(a);
  }
  function yb(a) {
  ...
  function x(a) {
    return new L(!1, !1, !1, a);
  }
  function M(a, b) {
    var c = a.type;
    if (0 === c) return ((c = a.data.length), new L(!0, 1 <= c, 2 <= c, b));
    if (4 === c)
      return ((c = a.data), new L(c.thisDep, c.contextDep, c.propDep, b));
    if (5 === c) return new L(!1, !1, !1, b);
    if (6 === c) {
          ...
          : 2 === q.type
            ...
            : 3 === q.type
              ...
              : 0 === q.type
                ...
                : 4 === q.type &&
                  ((c = c || q.data.thisDep),
                  (e = e || q.data.contextDep),
                  (f = f || q.data.propDep));
      }
      return new L(c, e, f, b);
    }
    return new L(3 === c, 2 === c, 1 === c, b);
  }
  function Wb(a, b, c, e, f, d, q, n, u, h, v, m, C, p, k) {
    function g(a) {
      return a.replace(".", "_");
    }
    function r(a, b, c) {
    ...
    function D() {
      ...
      Object.keys(ta).forEach(function (a) {
        Array.isArray(ra[a]) &&
          ((g[a] = d.def(f.next, ".", a)), (A[a] = d.def(f.current, ".", a)));
      });
      var F = (a.constants = {});
      Object.keys(Pa).forEach(function (a) {
        F[a] = d.def(JSON.stringify(Pa[a]));
      });
    ...
    function E(a, b, c) {
      function d(a) {
        ...
        return b
          ? new L(b.thisDep, b.contextDep, b.propDep, function (a, b) {
      ...
      if ((a = d("viewport"))) {
        var g = a;
        a = new L(a.thisDep, a.contextDep, a.propDep, function (a, b) {
          var c = g.append(a, b),
            d = a.shared.context;
    ...
    function J(a, c, d) {
      ...
      var f = a["static"],
        ...
        ca = null;
      va(A) && va(F)
        ? ((ca = v.program(F.id, A.id, null, d)),
          (a = x(function (a, b) {
            return a.link(ca);
          })))
        : (a = new L(
            (A && A.thisDep) || (F && F.thisDep),
            (A && A.contextDep) || (F && F.contextDep),
            (A && A.propDep) || (F && F.propDep),
            function (a, b) {
              var c = a.shared.shader,
                d;
              d = A ? A.append(a, b) : b.def(c, ".", "frag");
              var e;
              e = F ? F.append(a, b) : b.def(c, ".", "vert");
              return b.def(c + ".program(" + e + "," + d + ")");
            },
          ));
      return { frag: A, vert: F, progVar: a, program: ca };
    }
    function O(a, b) {
      function c(a, b) {
        if (a in e) {
          var d = e[a] | 0;
          b ? (g.offset = d) : (g.instances = d);
          return x(function (a, c) {
            b && (a.OFFSET = d);
            return d;
          });
        }
        ...
        if (b) {
          ...
          if (A)
            return new L(F.thisDep, F.contextDep, F.propDep, function (a, b) {
              return b.def(
                a.shared.vao +
                  ".currentVAO?" +
                  a.shared.vao +
      ...
      var e = a["static"],
        ...
        F = (function () {
          if ("vao" in e) {
            var a = e.vao;
            null !== a && null === h.getVAO(a) && (a = h.createVAO(a));
            A = !0;
            g.vao = a;
            return x(function (b) {
              var c = h.getVAO(a);
        ...
        la = (function () {
          if ("elements" in e) {
            ...
            g.elements = a;
            if (Sa(a)) {
              var b = (g.elements = d.create(a, !0)),
                a = d.getElements(b);
              ca = !0;
            } else a && ((a = d.getElements(a)), (ca = !0));
            b = x(function (b, c) {
              if (a) {
                var d = b.link(a);
                return (b.ELEMENTS = d);
          ...
          if ("elements" in f) {
            ...
            return M(c, function (a, b) {
              var d = a.shared,
                ...
                f = a
                  .cond(e)
                  .then(w, "=", d, ".createStream(", f, ");")
                  ["else"](w, "=", d, ".getElements(", f, ");");
              b.entry(f);
          ...
          return A
            ? new L(F.thisDep, F.contextDep, F.propDep, function (a, b) {
                return b.def(
                  a.shared.vao +
                    ".currentVAO?" +
                    a.shared.elements +
        ...
        l = (function () {
          ...
          return ca
            ? va(la)
              ...
              : new L(la.thisDep, la.contextDep, la.propDep, function (a, b) {
                  var c = a.ELEMENTS;
        ...
        k = (function () {
          ...
          return ca
            ? va(la)
              ? la
                ? ba
                  ? new L(ba.thisDep, ba.contextDep, ba.propDep, function (
                      a,
                      b,
                    ) {
              ...
              : new L(
                  la.thisDep || ba.thisDep,
                  la.contextDep || ba.contextDep,
                  la.propDep || ba.propDep,
                  function (a, b) {
                    var c = a.ELEMENTS;
                    return a.OFFSET
      ...
      Na.forEach(function (a) {
        ...
        switch (a) {
          ...
          case "blend.equation":
            return b(
              function (a) {
                if ("string" === typeof a) return [ga[a], ga[a]];
                if ("object" === typeof a) return [ga[a.rgb], ga[a.alpha]];
              },
              function (a, b, c) {
          ...
          case "blend.color":
            return b(
              function (a) {
                return S(4, function (b) {
                  return +a[b];
                });
              },
              function (a, b, c) {
                return S(4, function (a) {
                  return b.def("+", c, "[", a, "]");
                });
              },
            );
    ...
    function ua(a, c) {
      ...
      Object.keys(d).forEach(function (a) {
        ...
        if (Sa(c))
          ((w.state = 1),
            (w.buffer = f.getBuffer(f.create(c, 34962, !1, !0))),
            (w.type = 0));
        else {
          var B = f.getBuffer(c);
          if (B) ((w.state = 1), (w.buffer = B), (w.type = 0));
      ...
      Object.keys(e).forEach(function (a) {
        ...
        g[a] = M(b, function (a, c) {
          ...
          d("divisor");
          c("}}");
          c.exit("if(", B.isStream, "){", f, ".destroyStream(", k, ");", "}");
          return B;
        });
      });
      return g;
    ...
    function z(a, b, d, e, f) {
      ...
      l("viewport");
      l(g("scissor.box"));
      var Xb = 0 < Object.keys(ba).length,
        m = {
          framebuffer: m,
          draw: n,
          shader: q,
      ...
      m.profile = t(a, f);
      m.uniforms = U(d, f);
      m.drawVAO = m.scopeVAO = n.vao;
      if (
        !m.drawVAO &&
        q.program &&
        !k &&
        c.angle_instanced_arrays &&
        n["static"].elements
      ) {
        var r = !0;
        a = q.program.attributes.map(function (a) {
          a = b["static"][a];
          r = r && !!a;
          return a;
        });
        if (r && 0 < a.length) {
          var v = h.getVAO(
            h.createVAO({ attributes: a, elements: n["static"].elements }),
          );
          m.drawVAO = new L(null, null, null, function (a, b) {
            return a.link(v);
          });
          m.useVAO = !0;
        }
      }
      k ? (m.useVAO = !0) : (m.attributes = ua(b, f));
      m.context = H(e, f);
      return m;
    }
    function ia(a, b, c) {
    ...
    function T(a, b, c, d) {
      var e = a.shared,
        ...
        g = e.framebuffer,
        l;
      Ma && (l = b.def(e.extensions, ".webgl_draw_buffers"));
      var k = a.constants,
        e = k.drawBuffer,
        k = k.backBuffer;
      ...
      Ma &&
        b(l, ".drawBuffersWEBGL(", e, "[", a, ".colorAttachments.length]);");
      b("}else{", f, ".bindFramebuffer(", 36160, ",null);");
      Ma && b(l, ".drawBuffersWEBGL(", k, ");");
      b("}", g, ".cur=", a, ";");
      d || b("}");
    }
    function za(a, b, c) {
      ...
      Na.forEach(function (b) {
        ...
        if (!(b in c.state)) {
          ...
          if (b in k) {
            d = k[b];
            B = f[b];
            var n = S(ra[b].length, function (a) {
              return h.def(d, "[", a, "]");
            });
            h(
              a
      ...
      0 === Object.keys(c.state).length && h(l, ".dirty=false;");
      b(h);
    }
    function K(a, b, c, d) {
      var e = a.shared,
        ...
        g = e.current,
        l = e.gl;
      yb(Object.keys(c)).forEach(function (e) {
        var k = c[e];
        if (!d || d(k)) {
          var h = k.append(a, b);
          if (sa[e]) {
    ...
    function G(a, b, c, d, e) {
      ...
      function g(a) {
        t = b.def();
        a(t, "=", f(), ";");
        "string" === typeof e ? a(m, ".count+=", e, ";") : a(m, ".count++;");
        p &&
          (d
      ...
      if (c) {
        if (va(c)) {
          c.enable ? (g(b), l(b.exit), k("true")) : k("false");
          return;
        }
        c = c.append(a, b);
        k(c);
    ...
    function ha(a, b, c, d, e) {
      ...
      function g(c, d, e) {
        function f() {
          b("if(!", n, ".buffer){", h, ".enableVertexAttribArray(", m, ");}");
          var c = e.type,
            g;
          ...
          b(
            ...
            h,
            ".vertexAttribPointer(",
            [m, g, c, e.normalized, e.stride, e.offset],
            ");",
            n,
            ".type=",
            c,
      ...
      d.forEach(function (d) {
        ...
        if (k) {
          ...
          h = {};
          Object.keys(new fa()).forEach(function (a) {
            h[a] = b.def(m, ".", a);
          });
        }
        g(a.link(d), f(d.info.type), h);
      });
    }
    function R(a, c, d, e, f, g) {
      for (var l = a.shared, k = l.gl, h, m = 0; m < e.length; ++m) {
        var n = e[m],
          p = n.name,
          q = n.info.type,
          t = d.uniforms[p],
        ...
        if (t) {
          ...
          if (va(t)) {
            p = t.value;
            if (35678 === q || 35680 === q)
              ((q = a.link(p._texture || p.color[0]._texture)),
                c(k, ".uniform1i(", n, ",", q + ".bind());"),
                c.exit(q, ".unbind();"));
            else if (35674 === q || 35675 === q || 35676 === q)
              ((p = a.global.def(
                "new Float32Array([" + Array.prototype.slice.call(p) + "])",
              )),
                (t = 2),
                35675 === q ? (t = 3) : 35676 === q && (t = 4),
                c(k, ".uniformMatrix", t, "fv(", n, ",false,", p, ");"));
            else {
              switch (q) {
                case 5126:
                  h = "1f";
              ...
              c(
                ...
                n,
                ",",
                pa(p) ? Array.prototype.slice.call(p) : p,
                ");",
              );
            }
            continue;
        ...
        if ("M" === h.charAt(0)) {
          c(k, ".uniform", h, "(", n, ",");
          var n = Math.pow(q - 35674 + 2, 2),
            v = a.global.def("new Float32Array(", n, ")");
          Array.isArray(r)
            ? c(
                "false,(",
                S(n, function (a) {
          ...
          if (1 < p) {
            ...
            c(k, ".uniform", h, "(", n, ",", u.join(","), ");");
          } else
            (g &&
              ((q = c.def()),
              c("if(!", a.batchId, "||", q, "!==", r, "){", q, "=", r, ";")),
              c(k, ".uniform", h, "(", n, ",", r, ");"));
          g && c("}");
        }
      }
    ...
    function V(a, b, c, d) {
          ...
          if (e) {
            ...
            ((e = f.def()),
              f(
                ...
                e,
                "=",
                a.shared.elements + ".getElements(" + h.vao,
                ".currentVAO.elements);",
                ma
                  ? ""
                  : "if(" +
      ...
      var t, v;
      X && ((t = e("instances")), (v = a.instancing));
      var u = n + ".type",
        C = m.elements && va(m.elements) && !m.vaoActive;
      X && ("number" !== typeof t || 0 <= t)
        ? "string" === typeof t
          ? (c("if(", t, ">0){"), f(), c("}else if(", t, "<0){"), g(), c("}"))
          : f()
        : g();
    }
    function ea(a, b, c, d, e) {
      ...
      e = b.proc("body", e);
      X &&
        (b.instancing = e.def(b.shared.extensions, ".angle_instanced_arrays"));
      a(b, e, c, d);
    ...
    function Z(a, b, c, d) {
      ...
      c.useVAO
        ...
        : (b(a.shared.vao, ".setVAO(null);"),
          ha(a, b, c, d.attributes, function () {
            return !0;
          }));
      R(
        a,
    ...
    function Ea(a, b) {
      ...
      if (b.shader.program) Z(a, c, b, b.shader.program);
      else {
    ...
    function oa(a, b, c, d) {
      ...
      c.needsContext && ia(a, m, c.context);
      c.needsFramebuffer && T(a, m, c.framebuffer);
      K(a, m, c.state, e);
      c.profile && e(c.profile) && G(a, m, c, !1, !0);
      d
        ? (c.useVAO
            ? c.drawVAO
              ? e(c.drawVAO)
                ? m(a.shared.vao, ".setVAO(", c.drawVAO.append(a, m), ");")
                : l(a.shared.vao, ".setVAO(", c.drawVAO.append(a, l), ");")
              : l(a.shared.vao, ".setVAO(", a.shared.vao, ".targetVAO);")
            : (l(a.shared.vao, ".setVAO(null);"),
              ha(a, l, c, d.attributes, f),
              ha(a, m, c, d.attributes, e)),
          R(a, l, c, d.uniforms, f, !1),
          R(a, m, c, d.uniforms, e, !0),
          V(a, l, m, c))
        : ((b = a.global.def("{}")),
    ...
    function W(a, b) {
      ...
      f = b.shader.progVar;
      if ((f.contextDep && e) || f.propDep) oa(a, d, b, null);
      else if (
        ((f = f.append(a, d)),
        d(a.shared.gl, ".useProgram(", f, ".program);"),
        b.shader.program)
      )
        oa(a, d, b, b.shader.program);
      else {
    ...
    function ja(a, c) {
      ...
      yb(Object.keys(c.state)).forEach(function (b) {
    ...
    function aa(a, b, c) {
      ...
      if (e && ka(e)) {
        ...
        g.forEach(function (b) {
          var c = e[b];
          if (Y.isDynamic(c))
            ("function" === typeof c && (c = e[b] = Y.unbox(c)),
              (b = M(c, null)),
              (h = h || b.thisDep),
              (k = k || b.propDep),
              (l = l || b.contextDep));
    ...
    var fa = h.Record,
      ga = { add: 32774, subtract: 32778, "reverse subtract": 32779 };
    c.ext_blend_minmax && ((ga.min = 32775), (ga.max = 32776));
    var X = c.angle_instanced_arrays,
      Ma = c.webgl_draw_buffers,
      ma = c.oes_vertex_array_object,
      ra = { dirty: !0, profile: k.profile },
      Da = {},
      Na = [],
      sa = {},
      ta = {};
    ...
    Ma &&
      ((Pa.backBuffer = [1029]),
      (Pa.drawBuffer = S(e.maxDrawbuffers, function (a) {
        return 0 === a
          ? [0]
          : S(a, function (a) {
              return 36064 + a;
    ...
    return {
      ...
      procs: (function () {
        ...
        c.oes_vertex_array_object &&
          d(a.link(c.oes_vertex_array_object), ".bindVertexArrayOES(null);");
        for (var n = 0; n < e.maxAttributes; ++n) {
          ...
          d(q);
          X && d(m, ".vertexAttribDivisorANGLE(", n, ",", p, ".divisor);");
        }
        d(
          a.shared.vao,
          ".currentVAO=null;",
  ...
  var N = function (a, b) {
    ...
    Y = {
      ...
      isDynamic: function (a) {
        return ("function" === typeof a && !a._reglType) || a instanceof Z;
      },
      unbox: db,
      accessor: cb,
    },
  ...
  var Zb = function (a, b) {
      ...
      b.webgl_draw_buffers &&
        ((e = a.getParameter(34852)), (f = a.getParameter(36063)));
      ...
      if (d) {
        ...
        if (36053 !== a.checkFramebufferStatus(36160)) d = !1;
          ...
          a.clear(16384);
          var n = I.allocType(5126, 4);
          a.readPixels(0, 0, 1, 1, 6408, 5126, n);
          a.getError()
            ? (d = !1)
            : (a.deleteFramebuffer(q), a.deleteTexture(d), (d = 1 === n[0]));
          I.freeType(n);
        }
      }
      n = !0;
      ("undefined" !== typeof navigator &&
        ...
        ((n = a.createTexture()),
        (q = I.allocType(5121, 36)),
        a.activeTexture(33984),
        a.bindTexture(34067, n),
        a.texImage2D(34069, 0, 6408, 3, 3, 0, 6408, 5121, q),
        I.freeType(q),
        a.bindTexture(34067, null),
        a.deleteTexture(n),
        (n = !a.getError()));
    ...
    Qa = {
      ...
      flatten: function (a, b, c, e) {
        var f = 1;
        if (b.length) for (var d = 0; d < b.length; ++d) f *= b[d];
        else f = 0;
        c = e || I.allocType(c, f);
        switch (b.length) {
          case 0:
          ...
          case 2:
            ...
            b = b[1];
            for (d = f = 0; d < e; ++d)
              for (var q = a[d], n = 0; n < b; ++n) c[f++] = q[n];
            break;
          case 3:
    ...
    nb = { dynamic: 35048, stream: 35040, static: 35044 },
    Ua = Qa.flatten,
    mb = Qa.shape,
    ma = [];
  ma[5120] = 1;
  ...
  var Ka = {
    ...
    pb = new Float32Array(1),
    Lb = new Uint32Array(pb.buffer),
    Pb = [9984, 9986, 9985, 9987],
    Oa = [0, 6409, 6410, 6407, 6408],
    V = {};
  V[6409] = V[6406] = V[6402] = 1;
  V[34041] = V[6410] = 2;
  V[6407] = V[35904] = 3;
  V[6408] = V[35906] = 4;
  var Xa = qa("HTMLCanvasElement"),
    Ya = qa("OffscreenCanvas"),
    ub = qa("CanvasRenderingContext2D"),
    vb = qa("ImageBitmap"),
    wb = qa("HTMLImageElement"),
    xb = qa("HTMLVideoElement"),
    Mb = Object.keys(Ha).concat([Xa, Ya, ub, vb, wb, xb]),
    ya = [];
  ya[5121] = 1;
  ya[5126] = 4;
  ya[36193] = 2;
          ...
          function h(b, c) {
            ...
            "object" === typeof b && b
              ...
              : "number" === typeof b
                ...
                : b || (d = e = 1);
            if (d !== k.width || e !== k.height || m !== k.format)
              return (
                (h.width = k.width = d),
                (h.height = k.height = e),
                (k.format = m),
                a.bindRenderbuffer(36161, k.renderbuffer),
                a.renderbufferStorage(36161, m, d, e),
                f.profile && (k.stats.size = R[k.format] * k.width * k.height),
                (h.format = u[k.format]),
                h
              );
          }
          var k = new d(a.createRenderbuffer());
          v[k.id] = k;
          e.renderbufferCount++;
          h(b, c);
          h.resize = function (b, c) {
            var d = b | 0,
              e = c | 0 || d;
            if (d === k.width && e === k.height) return h;
            h.width = k.width = d;
            h.height = k.height = e;
            a.bindRenderbuffer(36161, k.renderbuffer);
            a.renderbufferStorage(36161, k.format, d, e);
            f.profile && (k.stats.size = R[k.format] * k.width * k.height);
            return h;
          };
          h._reglType = "renderbuffer";
          h._renderbuffer = k;
          f.profile && (h.stats = k.stats);
          h.destroy = function () {
            k.decRef();
          };
          return h;
    ...
    ac = function (a, b) {
      ...
      return {
        ...
        update: function () {
          ...
          a = d.length;
          if (0 !== a) {
            h.length = Math.max(h.length, a + 1);
            u.length = Math.max(u.length, a + 1);
            u[0] = 0;
            var e = (h[0] = 0);
            for (c = a = 0; c < d.length; ++c) {
              var p = d[c];
              b.ext_disjoint_timer_query.getQueryObjectEXT(p, 34919)
            ...
            for (c = a = 0; c < n.length; ++c) {
              ...
              p = h[p];
              p === k
                ? ((e.stats.gpuTime += e.sum / 1e6), q.push(e))
                : ((e.startQueryIndex = k),
                  (e.endQueryIndex = p),
                  (n[a++] = e));
            }
        ...
        clear: function () {
          ...
          for (var a = 0; a < f.length; a++)
            b.ext_disjoint_timer_query.deleteQueryEXT(f[a]);
          d.length = 0;
          f.length = 0;
        },
        restore: function () {
  ...
  return function (a) {
    function b() {
      if (0 === G.length) (t && t.update(), (ea = null));
      else {
        ea = bb.next(b);
        v();
    ...
    function c() {
      !ea && 0 < G.length && (ea = bb.next(b));
    }
    function e() {
      ea && (bb.cancel(b), (ea = null));
    }
    function f(a) {
      a.preventDefault();
      e();
    ...
    function q(a) {
      ...
      var g = { gpuTime: 0, cpuTime: 0, count: 0 },
        h = K.compile(a, f, e, d, g),
        k = h.draw,
        l = h.batch,
        m = h.scope,
        n = [];
        ...
        function (a, b) {
          ...
          if ("function" === typeof b)
            if ("number" === typeof a)
              ...
              for (d = 0; d < a.length; ++d) m.call(this, a[d], b, d);
    ...
    function n(a, b) {
      ...
      var d = b.color;
      d &&
        (p.clearColor(+d[0] || 0, +d[1] || 0, +d[2] || 0, +d[3] || 0),
        (c |= 16384));
      "depth" in b && (p.clearDepth(+b.depth), (c |= 256));
      "stencil" in b && (p.clearStencil(b.stencil | 0), (c |= 1024));
      p.clear(c);
    }
    function u(a) {
      G.push(a);
    ...
    var r = Eb(),
      ...
      t = ac(p, D),
      I = Cb(),
      E = p.drawingBufferWidth,
      L = p.drawingBufferHeight,
      J = {
        tick: 0,
        time: 0,
        viewportWidth: E,
      ...
      E = { elements: null, primitive: 4, count: -1, offset: 0, instances: -1 },
      O = Zb(p, D),
      y = Jb(p, l, a, function (a) {
      ...
      Q = $b(p, D, O, l, a),
      T = Rb(p, D, O, z, Q, l),
      K = Wb(p, r, D, O, y, U, z, T, {}, M, H, E, J, t, a),
      r = Ub(p, T, K.procs.poll, J, k, D, O),
      R = K.next,
      P = p.canvas,
      G = [],
      S = [],
      ...
      ea = null;
    P &&
      (P.addEventListener("webglcontextlost", f, !1),
    ...
    k = N(q, {
      clear: function (a) {
        if ("framebuffer" in a)
          if (a.framebuffer && "framebufferCube" === a.framebuffer_reglType)
            for (var b = 0; 6 > b; ++b)
              aa(N({ framebuffer: a.framebuffer.faces[b] }, a), n);
          else aa(a, n);
        else n(null, a);
      },
      ...
      hasExtension: function (a) {
        return 0 <= O.extensions.indexOf(a.toLowerCase());
      },
      read: r,
      destroy: function () {
        G.length = 0;
        e();
        P &&
          (P.removeEventListener("webglcontextlost", f),
          P.removeEventListener("webglcontextrestored", d));
        H.clear();
        T.clear();
        Q.clear();
        M.clear();
